	...
	<section id="container">
        ...
        *********************************************************************************************************************************************************** -->
		...
		<header class="header black-bg">
			...
			<!--logo start-->
			<a href="index.html" class="logo"><b>Ne<span>X</span>us</b></a>
			<!--logo end-->
...
<!-- 						class="dropdown-toggle" href="index.html#"> <i class="fa fa-tasks"></i> <span class="badge bg-theme">4</span> -->
<!-- 					</a> -->
...
<!-- 										alt="avatar" src="../Nexus/src/img/ui-zac.jpg"></span> <span -->
<!-- 									class="photo"><img alt="avatar" -->
<!-- 										src="request.getContextPath()/ui-zac.jpg"></span> <span -->
...
<!-- 			</div> -->
			<div class="top-menu">
				<ul class="nav pull-right top-menu">
					<li><a class="logout" href="/deslogar">Logout</a></li>
				</ul>
			</div>
		</header>
		<!--header end-->
